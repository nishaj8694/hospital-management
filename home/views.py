...
def email_otp(user):
        try:  
            ...
            print(Person.email,email_from,message,subject)
            recipient_list=[Person.email]
            a=send_mail(message,subject,email_from,recipient_list)     
            print(a)
            return True
        except:
            print('emil not')
...
def send_otp(user):
            ...
            message = client.messages.create(
                ...
                from_='+12705186002',  # Twilio phone number
                to=customer.contact_number,  # User's phone number
            )
